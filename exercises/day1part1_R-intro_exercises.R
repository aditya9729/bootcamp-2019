...
gapminder <- read.csv("C:/Users/Lenovo/Desktop/MSIA materials/bootcamp-2019/data/gapminder5.csv", stringsAsFactors=FALSE)

# Load the readr package
require(readr)

# Read gapminder data with read_csv()
gapminder<-read_csv("C:/Users/Lenovo/Desktop/MSIA materials/bootcamp-2019/data/gapminder5.csv")
...
prop.table(table(gapminder07$lifeExp_highlow))
...
t.test(gdpPercap~lifeExp_highlow,data=gapminder07)
...
write.csv(x = gapminder07,file="C:/Users/Lenovo/Desktop/MSIA materials/bootcamp-2019/data/gapminder07.csv",row.names=F)
...
hist(gapminder07$lifeExp,main="Histogram of Life Expectancy",xlab=('Life Expectancy'),ylab='Frequency')

# Bonus: Change the `breaks = ` argument from its default setting and see what happens.
hist(gapminder07$lifeExp,main="Histogram of Life Expectancy",xlab=('Life Expectancy'),ylab='Frequency',breaks=seq(50,60,70))


#### Scatterplots ####
dev.off()
# Create a scatterplot with `lifeExp` on the y-axis and `gdpPercap` on the x-axis.
plot(x = gapminder07$gdpPercap,y=gapminder07$lifeExp)


# Add a title and axis labels.
plot(x = gapminder07$gdpPercap,y=gapminder07$lifeExp,main='A scatterplot of LifeExp vs GDP',xlab='GDP',ylab='Life Expectancy')


# Bonus: Add a horizontal line indicating the mean of `lifeExp` onto the plot using `abline()`.
abline(h=mean(gapminder07$lifeExp))

lines(loess.smooth(x= gapminder07$gdpPercap,y=gapminder07$lifeExp,degree=5),col='red')
